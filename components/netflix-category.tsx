...
export function NetflixCategory() {
  ...
  const handlePurchase = () => {
    ...
    if (tier) {
      alert(`Proceeding to purchase Netflix ${tier.duration} subscription for ${tier.price} EGP`)
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center mb-6">
            <div className="bg-red-600 text-white px-6 py-2 rounded-lg">
              <span className="text-2xl font-bold tracking-wide">NETFLIX</span>
            </div>
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Get unlimited access to movies, TV shows, and exclusive Netflix originals. 
            Choose your plan and start streaming today!
          </p>
        </div>
            ...
            <div
              ...
              className={`relative cursor-pointer rounded-2xl p-8 transition-all duration-300 ${
                selectedTier === tier.id
                  ? 'bg-red-600 scale-105 shadow-2xl shadow-red-600/30'
                  : 'bg-gray-800 hover:bg-gray-750 hover:scale-102'
              } ${tier.popular ? 'ring-2 ring-red-500' : ''}`}
            >
              {tier.popular && (
        ...
        <div className="text-center">
          <button
            ...
            className={`px-12 py-4 rounded-lg font-bold text-lg transition-all duration-300 ${
              selectedTier
                ? 'bg-red-600 text-white hover:bg-red-700 shadow-lg hover:shadow-red-600/40'
